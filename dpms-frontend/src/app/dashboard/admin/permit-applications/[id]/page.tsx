...
import { getPermitApplication, updatePermitApplication } from '@/lib/permit'
...
export default function AdminPermitApplicationPage({
  params,
  ...
  const handleUpdateStatus = async (approved: boolean) => {
    if (!application) return

    try {
      setIsUpdating(true)
      await updatePermitApplication({
        id: application.id,
        is_approved: approved,
      })

      toast.success(
        `Permit application ${approved ? 'approved' : 'rejected'} successfully`
      )
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to reject this permit application?
                      This action cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <div className='mt-4'>
                    <Textarea
                      placeholder='Add a comment explaining the rejection reason...'
                      value={comment}
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to approve this permit application?
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <div className='mt-4'>
                    <Textarea
